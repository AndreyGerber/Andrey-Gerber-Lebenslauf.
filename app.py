...
with exp_col1:
    st.markdown("""
        <div class="exp-box">
            ...
            <div class="no-bullet" style="margin-bottom: 15px;"><strong>sollte machbar sein. SAP kann jeder und niemand gleichzeitig.</strong></div>
...
with exp_col2:
    st.markdown("""
        <div class="exp-box">
            ...
            <div class="no-bullet", style="margin-bottom: 105px;">Hier müssen wir zunächst die Begriffe definieren, bevor aneinander gesprochen wird.</div>
        </div>
        """, unsafe_allow_html=True)

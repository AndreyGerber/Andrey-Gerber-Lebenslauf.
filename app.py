    ...
    # --- INNERHALB DEINES 750px CONTAINERS ---
        ...
        fig_flight.update_layout(
            ...
            geo = dict(
                ...
                # Hier waren die Werte leer, jetzt sind sie wieder da:
                lataxis = dict(range=[45, 65], showgrid=False, showticklabels=False),
                lonaxis = dict(range=[5, 85], showgrid=False, showticklabels=False),
                resolution = 50
            ),
            showlegend = False
        )
